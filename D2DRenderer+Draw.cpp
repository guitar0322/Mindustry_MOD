...
void D2DRenderer::RenderText(const int x, const int y, const wstring& text, const int size,
	const wstring& font, const DefaultBrush& defaultBrush, const DWRITE_TEXT_ALIGNMENT& align)
{
	Vector2 pos(x, y);
...
************************************************************************************************/
void D2DRenderer::RenderText(const int x, const int y, const wstring& text, const int size, const float alpha, const wstring& font, const DefaultBrush& defaultBrush, const DWRITE_TEXT_ALIGNMENT& align)
{
	Vector2 pos(x, y);
...
{
	Rect rc = RectMakePivot(origin, Vector2(radius, radius), Pivot::Center);
	Vector2 pos = origin;
...
@@ bool isRelative : 카메라 보정여부
************************************************************************************************/
void D2DRenderer::FillRectangle(const Rect& rc, const DefaultBrush& defaultBrush)
{
	Rect rect = rc;
...
void D2DRenderer::DrawRotationNullRectangle(const Rect& rc, const D2D1::ColorF::Enum& color,
...
void D2DRenderer::DrawRotationFillRectangle(const Rect& rc, const D2D1::ColorF& color, const float angle)
{
	Rect rect = rc;
