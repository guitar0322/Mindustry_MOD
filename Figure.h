...
namespace Figure
{
	...
	*****************************************************************************************************/
	...
	## RectMake ##
	*****************************************************************************************************/
	inline FloatRect RectMake(const float& x, const float& y,const float& width,const float& height)
	{
		FloatRect result;
		result.left = x;
		result.top = y;
	...
	inline FloatRect RectMake(const Vector2& pos,const Vector2& size)
	{
		FloatRect result;
		result.left = pos.x;
		result.top = pos.y;
